...
- 了解 [什么是 MCP？](/dashboard/tutorials/what-is-mcp)
- 浏览 [Agent Hub](/dashboard/agents) 发现更多工具
`,
    level: 'beginner',
    category: 'concept',
...
👉 [查看 Dify 使用案例](/dashboard/usecases)
`,
    level: 'intermediate',
    category: 'hands-on',
